...
// Using null coalescing operators as a fallback just in case
$patientName = $_SESSION['patient_name'] ?? 'Guest Patient';
$patientRef  = $_SESSION['patient_ref'] ?? 'N/A';

// 3. MOCK DATABASE RESULTS
// In a real application, you would connect to your database using PDO or MySQLi 
// and SELECT these records based on the $patientRef.
$mockResults = [
    [
